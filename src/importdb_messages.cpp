...
namespace
{
  ...
  const entry importdb_messages[] = {
    ...
    { 33, "importdb: stripped %1$d constraint(s) from '%2$s'.\n" },
    { 34, "importdb: loading object data from '%1$s' failed: %2$s\n" },
    { 35, "importdb: loaded %1$ld row(s) from %2$d object file(s) into '%3$s'.\n" },
    ...
    { 39, "importdb: rebuilt %1$d constraint(s) and built %2$d index(es) on '%3$s'.\n" },
    ...
    { 42, "importdb: every FOREIGN KEY on '%1$s' was accepted by the engine -- %2$d edge(s) clean, %3$d skipped (parent key withheld).\n" },
    ...
    { 46, "importdb: defined %1$d FK(s) on '%2$s'.\n" },
    ...
    { 59, "importdb: loaded %1$ld row(s) from %2$d object file(s) into '%3$s' at degree %4$d.\n" },
