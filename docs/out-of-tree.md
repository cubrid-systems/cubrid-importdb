...
How this repo builds against CUBRID without living inside it, what it depends on,
and what keeps that dependency from breaking silently. If you only want to *use*
`cubrid-importdb`, the [README](../README.md) is the place to start.
